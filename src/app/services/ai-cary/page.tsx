export default function CaryAIPage() {
  return (
      ...
      <div className="row justify-content-center">
        <div className="col-lg-10">
          ...
          <section className="text-center mb-5">
            ...
            <div className="mx-auto mb-4" style={{maxWidth: '700px'}}>
              <div className="alert custom-alert p-4 mb-4 shadow-lg">
                Serving Cary and the Triangle area with secure, branded AI solutions. From custom chatbots to enterprise AI integration, I help local businesses leverage AI technology effectively.
              </div>
            </div>
          </section>
          ...
          <section className="mb-5">
            <h3 className="fw-bold mb-4 section-headline-gold text-center">Why Choose a Local Cary AI Developer?</h3>
            <div className="row justify-content-center">
              ...
              <div className="col-md-4 mb-4">
                <div className="card purple-box credential-card">
                  ...
                  <p>Face-to-face consultations and ongoing support for Cary businesses and surrounding communities</p>
                </div>
              </div>
              <div className="col-md-4 mb-4">
                <div className="card golden-box credential-card">
          ...
          {/* Services Section */}
          <section className="mb-5">
            <h3 className="fw-bold mb-4 section-headline-green text-center">AI Development Services in Cary</h3>
            ...
            <div className="row justify-content-center">
              <div className="col-md-8">
                <div className="card purple-box knowledge-card mb-4">
                  ...
                  <p>As a Triangle area AI developer, I understand the unique challenges and opportunities facing Cary businesses. My solutions are designed with local business needs in mind:</p>
                  <ul className="mb-4">
          ...
          <section className="mb-5">
            ...
            <div className="text-center my-4">
              <p className="mb-4">Experience a live demo of a custom AI assistant. See how Cary businesses can leverage AI technology effectively.</p>
          ...
          <section className="mb-5">
            ...
            <div className="row justify-content-center">
              <div className="col-md-8 text-center">
                ...
                <p className="mt-3 text-secondary">Serving Cary, Raleigh, Durham, Wake Forest, and the entire Triangle area.</p>
              </div>
            </div>
          </section>
        </div>

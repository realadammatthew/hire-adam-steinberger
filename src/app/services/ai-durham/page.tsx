export default function DurhamAIPage() {
  return (
      ...
      <div className="row justify-content-center">
        <div className="col-lg-10">
          ...
          <section className="text-center mb-5">
            ...
            <div className="mx-auto mb-4" style={{maxWidth: '700px'}}>
              <div className="alert custom-alert p-4 mb-4 shadow-lg">
                Serving Durham and the Triangle area with secure, branded AI solutions. From custom chatbots to enterprise AI integration, I help local businesses leverage AI technology effectively.
              </div>
            </div>
          </section>
          ...
          <section className="mb-5">
            <h3 className="fw-bold mb-4 section-headline-gold text-center">Why Choose a Local Durham AI Developer?</h3>
            <div className="row justify-content-center">
              <div className="col-md-4 mb-4">
                <div className="card golden-box credential-card">
                  ...
                  <p>Deep understanding of Durham&apos;s tech ecosystem and business landscape, serving the entire Triangle area</p>
                </div>
              </div>
              <div className="col-md-4 mb-4">
                <div className="card purple-box credential-card">
                  ...
                  <p>Face-to-face consultations and ongoing support for Durham businesses and surrounding communities</p>
                </div>
              </div>
              <div className="col-md-4 mb-4">
                <div className="card golden-box credential-card">
          ...
          {/* Services Section */}
          <section className="mb-5">
            <h3 className="fw-bold mb-4 section-headline-green text-center">AI Development Services in Durham</h3>
          ...
          <section className="mb-5">
            <h3 className="fw-bold mb-4 section-headline-blue text-center">Serving Durham & Triangle Area</h3>
            <div className="row justify-content-center">
              <div className="col-md-8">
                <div className="card purple-box knowledge-card mb-4">
                  <h5 className="mb-3"><i className="fas fa-star"></i> Local Expertise You Can Trust</h5>
                  <p>As a Triangle area AI developer, I understand the unique challenges and opportunities facing Durham businesses. My solutions are designed with local business needs in mind:</p>
                  <ul className="mb-4">
                    <li>Compliance with North Carolina business regulations</li>
                    <li>Integration with popular Triangle area business tools</li>
                    <li>Understanding of Durham&apos;s tech ecosystem and market dynamics</li>
                    <li>Personal, hands-on support and consultation</li>
                  </ul>
                  <p>Whether you&apos;re in Durham, Raleigh, Cary, or Wake Forest, I provide the same high-quality AI development services with local expertise.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="mb-5">
            ...
            <div className="text-center my-4">
              <p className="mb-4">Experience a live demo of a custom AI assistant. See how Durham businesses can leverage AI technology effectively.</p>
          ...
          <section className="mb-5">
            ...
            <div className="row justify-content-center">
              <div className="col-md-8 text-center">
                <p className="mb-4">Let&apos;s discuss how AI can transform your Durham business. Schedule a free consultation to explore your options.</p>
                <a 
                ...
                <p className="mt-3 text-secondary">Serving Durham, Raleigh, Cary, Wake Forest, and the entire Triangle area.</p>
              </div>
            </div>
          </section>
        </div>

  ...
  return (
    <div className="min-h-screen bg-dark text-light">
      ...
      <section className="container my-5">
        <h4 className="fw-bold mb-4 section-headline-gold text-center">Why Choose a Local Wake Forest AI Developer?</h4>
        <div className="row justify-content-center">
          <div className="col-md-4 mb-4">
            <div className="card golden-box credential-card">
              ...
              <p>Based in Wake Forest, NC with deep understanding of Triangle area business needs and regulations</p>
            </div>
          </div>
          <div className="col-md-4 mb-4">
            <div className="card purple-box credential-card">
              ...
              <p>Face-to-face consultations and ongoing support for Wake Forest and surrounding communities</p>
            </div>
          </div>
          <div className="col-md-4 mb-4">
            <div className="card golden-box credential-card">
      ...
      {/* Services Section */}
      <section className="container my-5">
        <h4 className="fw-bold mb-4 section-headline-green text-center">AI Development Services in Wake Forest</h4>
      ...
      <section className="container my-5">
        <h4 className="fw-bold mb-4 section-headline-blue text-center">Serving Wake Forest & Triangle Area</h4>
        <div className="row justify-content-center">
          <div className="col-md-8">
            <div className="card purple-box knowledge-card mb-4">
              <h5 className="mb-3"><i className="fas fa-star"></i> Local Expertise You Can Trust</h5>
              <p>As a Wake Forest-based AI developer, I understand the unique challenges and opportunities facing Triangle area businesses. My solutions are designed with local business needs in mind:</p>
              <ul className="mb-4">

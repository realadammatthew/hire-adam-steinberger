        ...
        <div className="col-lg-10">
          ...
          <section className="text-center mb-5">
            ...
            <h2 className="fw-semibold mb-3 headline-gradient" style={{fontSize: '1.35rem'}}>
              Custom Chatbots & LLM Solutions for Triangle Area Businesses
            </h2>
          ...
          <section className="mb-5">
            <h3 className="fw-bold mb-4 section-headline-gold text-center">Why Choose a Local Raleigh AI Developer?</h3>
            <div className="row justify-content-center">
          ...
          {/* Services Section */}
          <section className="mb-5">
            <h3 className="fw-bold mb-4 section-headline-green text-center">AI Development Services in Raleigh</h3>
          ...
          <section className="mb-5">
            <h3 className="fw-bold mb-4 section-headline-blue text-center">Serving Raleigh & Triangle Area</h3>
            <div className="row justify-content-center">
